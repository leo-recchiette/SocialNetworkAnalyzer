...
function getNodeDimension( sn, graphType )
{
    ...
    else
    {
        ...
        {
            let selected = $('input[name="tw-node-type"]:checked');
            let nodeToDisplay = $(selected).val();
    ...
    viz.registerOnEvent("completed", (e)=>{
        viz["_network"].on("click", (event)=>{
            ...
            else
            {
                id = event.edges[0];
                $('.dataViz2').removeClass('dataViz2_selected');
                $('.links').addClass('dataViz2_selected');
            ...
            $.ajax({
                url: 'server.php',
                dataType: 'json',
                data: {dataToSearch,id},
                type: 'post',
                success: function (data) {
                    dataVisualization (data);
                },
                error: function () {
                    let selected = $('.dataViz2_selected').data('value');
